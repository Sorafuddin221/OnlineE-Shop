...
function UserDashboard({user}) {
    ...
    function logoutUser(){
        ...
        dispatch(clearCart()); // Dispatch clearCart on successful logout
        navigate('/')
        })
        .catch((error)=>{
  ...
  return (
    ...
    <div className="dashboard-container">
        <div className="profile-header" onClick={toggleMenu}>
            <img className='profile-avatar' src={user.avatar.url?user.avatar.url:'./images/profile.png'} alt="profile-img" />
