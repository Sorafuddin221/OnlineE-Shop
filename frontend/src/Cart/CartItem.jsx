...
import { removeErrors, removeItemFromCart, removeMessage } from '../features/cart/cartSlice';
import { toast } from 'react-toastify';
import { useDispatch, useSelector } from 'react-redux';

function CartItem({item}) {
    const {success,loading,error,message,cartItem}=useSelector(state=>state.cart)
  ...
  return (
    <div className="cart-item">
                    <div className="item-info">
                        <img src={typeof item.image === 'object' ? item.image.url : item.image} alt={item.name} className="item-image" />
