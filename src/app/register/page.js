...
import { register, clearErrors } from "@/store/slices/userSlice";
    ...
    <div className="bg-gray-50/50 min-h-screen flex items-center justify-center py-20 px-4">
      <div className="max-w-xl w-full">
        <div className="text-center mb-12">
           ...
           <p className="text-gray-400 font-bold uppercase tracking-[0.2em] text-[10px]">Join our community of event planners</p>
        </div>

        <div className="bg-white rounded-[3rem] p-10 md:p-12 border border-gray-100 shadow-2xl shadow-gray-200/50">
          <form onSubmit={registerSubmit} className="space-y-8">
            {/* Avatar Upload */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               <div className="col-span-1 md:col-span-2 space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4">Choose Password</label>
                  <div className="relative group">
                     <div className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-blue-600 transition-colors">
                        <Lock size={18} />
                     </div>
          ...
          <div className="mt-12 text-center">
             <p className="text-gray-400 text-xs font-bold">
               ...
               <Link href="/login" className="text-blue-600 hover:text-blue-700 transition border-b-2 border-blue-600/20 pb-0.5">
                  Sign In Instead
               </Link>
             </p>
          </div>
